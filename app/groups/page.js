...
import { getUserGroups, getPublicGroups, createGroup } from '../utils/groupsService';
          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-white font-bold text-lg">Groups</span>
              </div>
            </div>
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="mb-8">
            ...
            {myGroups.length === 0 ? (
              <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                <p className="text-gray-300">You are not a member of any groups yet.</p>
              </div>
            ) : (
                ...
                {myGroups.map((group) => (
                  ...
                  >
                    <div className="p-6">
                      ...
                      <p className="mt-2 text-gray-300 line-clamp-2">{group.description || 'No description'}</p>
                      <div className="mt-4 flex items-center text-sm">
                        <div className="text-gray-400 mr-4">
                          <span className="font-semibold text-emerald-400">{group.memberCount}</span> members
                        </div>
                        <div className="text-gray-400">
                          <span className="font-semibold text-emerald-400">{group.postCount}</span> posts
                        </div>
                      </div>
          ...
          <div>
            ...
            {publicGroups.length === 0 ? (
              <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                <p className="text-gray-300">No public groups available to join.</p>
              </div>
            ) : (
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
