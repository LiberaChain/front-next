...
export default function EthereumWalletVerification({
  isWalletConnected,
  loading,
  connectWallet,
  ...
  const walletType = WALLET_TYPE_ETHEREUM;
    ...
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-gray-400">
          Authenticate with your decentralized identity using your Ethereum
          wallet. You will have to prove the ownership over your wallet by
          signing a login request message.
        </p>
      </div>
      ...
      {!isWalletConnected ? (
        <div className="text-center">
          <p className="text-sm text-gray-300 mb-4">
            Connect your Ethereum wallet to authenticate with your decentralized
            identity
          </p>
          <button
      ...
      >
        <div className="flex items-center space-x-3">
          <button
            type="submit"
            disabled={
              (!isWalletConnected && walletType === WALLET_TYPE_ETHEREUM) ||
              loading
            }
